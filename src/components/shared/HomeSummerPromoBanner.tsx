  ...
  return (
    <div className="relative shrink-0 w-[min(441px,calc(100vw-2rem))]">
      ...
      <button
        ...
        className="absolute left-[2.5%] bottom-[5%] z-10 flex h-[37px] min-w-[147px] max-w-[45%] items-center justify-center rounded-[10px] bg-white px-4 text-[13px] font-poppins font-semibold text-[#FF6600] shadow-sm transition-colors hover:bg-[#FFF5EE] cursor-pointer"
      >
        Claim offer
      </button>
    </div>
