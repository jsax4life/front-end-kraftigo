  ...
  return (
    <div className="flex gap-3 sm:gap-4">
      ...
      <div className="flex flex-col items-center pt-1">
        <div
          className={`w-3 h-3 sm:w-4 sm:h-4 rounded-full border-2 border-white shadow-md ${dotColor} shrink-0`}
        ></div>
        {!isLast && (
          <div
      ...
      <div className="flex-1 w-full">
        ...
        <div
          className={`w-full bg-[#F6F6F6] border border-[#0000001A] rounded-xl p-4 sm:p-5 ${
            onClick ? "cursor-pointer hover:bg-gray-100 transition-colors active:scale-[0.99]" : ""
          }`}
          onClick={onClick}
        >
