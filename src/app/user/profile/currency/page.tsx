...
const CurrencyPage = () => {
  ...
  return (
    <main className="min-h-screen bg-[#F9FAFB] flex flex-col">
      <Header title="Currency" showLogout={false} />
      ...
      <div className="flex-1 max-w-2xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-[32px] border border-[#F2F4F7] shadow-sm overflow-hidden p-3">
             <h3 className="text-[11px] font-poppins font-bold text-[#98A2B3] uppercase tracking-widest mt-4 mb-4 ml-4">Select Currency</h3>
        ...
        <div className="mt-12 flex items-center gap-4 p-6 bg-white rounded-3xl border border-[#F2F4F7] shadow-sm">
            ...
            <p className="text-[13px] font-poppins text-[#667085] leading-relaxed">
                Prices will be converted based on the current market rate. Some artisans may have forced currency preferences.
            </p>
        </div>
      </div>
    </main>
