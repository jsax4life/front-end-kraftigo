  ...
  return (
    <main className="relative w-full min-h-screen bg-white pb-24">
      ...
      <div className={isLoading ? "opacity-50 pointer-events-none" : ""}>
          ...
          <div className="w-full px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3 lg:gap-4">
                <Card img="/meun.svg" title="Tasks" val={bookings.length.toString()} />
        ...
        {isLoading && (
          <div className="absolute inset-x-0 top-1/2 flex justify-center z-50">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {nextTask ? (
              ...
              <div className="bg-gray-50 rounded-2xl p-8 text-center border border-dashed border-gray-200">
                <p className="text-gray-500 font-poppins">No tasks scheduled for today.</p>
                <Button 
                  variant="primary" 
                  className="mt-4"
                  onClick={() => router.push("/tasker/schedule")}
