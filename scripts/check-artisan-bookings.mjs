 ...
 *
 * Logs in as a tasker, then hits GET /api/artisan/bookings and prints
...
async function main() {
  ...
  console.log("📦 Fetching GET /api/artisan/bookings...\n");
  const bookingsRes = await fetch(`${BASE_URL}/api/artisan/bookings`, {
    headers: {
